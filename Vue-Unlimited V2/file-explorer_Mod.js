...
(function () {
  ...
  // Base paths for Vue-Mod 1.3
  var baseRelative = '../download0/PxMod/Vue-Mod 1.3';
  ...
  try {
    ...
    if (typeof global !== 'undefined' && global.__explorerBgm && global.__explorerBgm._valid) {
      ...
      try { bgm.open(sfxPath + 'explorer_bgm.wav'); } catch (e) {}
      ...
      if (!pathStack || pathStack.length <= 1 || currentPath === startPath) {
        ...
        try {
          ...
          fadeOutBgm(300, function () {
            ...
            try { include('../download0/PxMod/Vue-Mod 1.3/main-menu.js'); } catch (e) { log('Could not include main-menu.js: ' + (e.message || e)); }
          ...
          try { include('../download0/PxMod/Vue-Mod 1.3/main-menu.js'); } catch (e) { log('navigateUp include error: ' + (e.message || e)); }
            ...
            try {
              ...
              if (currentPath === startPath) {
                ...
                fadeOutBgm(250, function () {
                  ...
                  try { include('../download0/PxMod/Vue-Mod 1.3/main-menu.js'); } catch (e) {}
