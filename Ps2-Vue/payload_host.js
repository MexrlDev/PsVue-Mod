(function () {
  ...
  // ==================== ANIMATED BACKGROUND ====================
  // Using your new background info: 60 frames, average duration 50ms (~20 FPS),
  // filenames zero-padded as frame_000 .. frame_059
  ...
  // ==================== LOGO DYNAMIC IDLE (from first script) ====================
  (function logoIdle() {
  ...
  // --- perform action for option (unchanged logic, with cleanup added) ---
  function performButtonAction(index) {
    var exitIndex = buttons.length - 1;
    if (index === exitIndex) {
      log('Going back to main menu...');
      // Clean up animation intervals before switching scripts
