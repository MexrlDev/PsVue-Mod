...
> [!WARNING]
> This project has will not be updated, ReWorked on, or get new releases. if you want to work on it you can fork it and maintenance it. it’ll stay free for everyone to use and do their own projects using it
> 
* date 29/05/2026
...
i am not responsible for any ps4/ps5 system that breaks after using it, follow the applying steps
