...
(function () {
  ...
  // Base paths for Vue-Mod 1.3 assets (except button and checkmark images which stay in /assets/img)
  ...
  // background (updated to mod folder)
  ...
  // logo: start faded (will fade in) and get dynamic idle loop (updated to mod folder)
  var logo = new Image({
  ...
  // --- Logo fade-in + dynamic idle loop (in-place) ---
