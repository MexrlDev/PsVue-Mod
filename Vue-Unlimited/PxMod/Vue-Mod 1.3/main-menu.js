  ...
  for (var i = 0; i < menuOptions.length; i++) {
    (function (i) {
      ...
      if (typeof useImageText !== 'undefined' && useImageText) {
        ...
        btnText.style = 'white'; // explicitly set white style
        btnText.alpha = 0.0;
      }
      ...
      (function startEntrance(btn, text, marker, idx) {
        ...
        var interval = jsmaf.setInterval(function () {
          ...
          // Ensure text remains white (style persists)
  ...
  function updateHighlight() {
    ...
    if (prevButton >= 0 && prevButton !== currentButton) {
      ...
      if (prevBtn && prevTxt && prevMark) {
        ...
        // ensure style is white (should be, but just in case)
        if (prevTxt.style) prevTxt.style = 'white';
      }
    }
    ...
    for (var i = 0; i < buttons.length; i++) {
      ...
      // Re-assert white style for text (in case something changed it)
      if (t && t.style) t.style = 'white';
    }
